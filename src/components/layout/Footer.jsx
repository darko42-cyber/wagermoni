    ...
    <footer className='bg-slate-200 h-full max-h-sm mt-10 p-5'>
      <div className='flex flex-col gap-10 lg:gap-0 lg:flex lg:flex-row lg:justify-around'>
        <section>
          ...
          <div className='flex flex-col'>
            <p className='max-w-sm w-full text-gray-700'>
              Constant victory is assured and you will have
              nothing to loose or fear when you sign up to
              any premium package or buy odds from us
            </p>
          </div>
        </section>
        ...
        <section className='flex flex-col gap-5'>
          ...
          <p className='max-w-sm w-full text-gray-700'>
            Be the first to receive update about our plans
            and new premium features
          </p>
